#2014080101
- #####Fix end-of-line issue causing problems for provisioning
  There was a small bug in the previous version where a '\r' was
  expected by HQ, but not being generated by Bootstrap. This fixes it.
